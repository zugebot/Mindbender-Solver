...
PERM_MACRO(R_01_1) {
    board.b1 = board.b1 & MASK_R0_NT | (board.b1 & MASK_R0_B1) >> 3 | (board.b1 & MASK_R0_S1) << 15;
    board.b1 = board.b1 & MASK_R1_NT | (board.b1 & MASK_R1_B1) >> 3 | (board.b1 & MASK_R1_S1) << 15;
    board.addFatX(1);
}


PERM_MACRO(R_01_2) {
    board.b1 = board.b1 & MASK_R0_NT | (board.b1 & MASK_R0_B2) >> 6 | (board.b1 & MASK_R0_S2) << 12;
    board.b1 = board.b1 & MASK_R1_NT | (board.b1 & MASK_R1_B2) >> 6 | (board.b1 & MASK_R1_S2) << 12;
    board.addFatX(2);
}
PERM_MACRO(R_01_3) {
    board.b1 = board.b1 & MASK_R0_NT | (board.b1 & MASK_R0_B3) >> 9 | (board.b1 & MASK_R0_S3) << 9;
    board.b1 = board.b1 & MASK_R1_NT | (board.b1 & MASK_R1_B3) >> 9 | (board.b1 & MASK_R1_S3) << 9;
    board.addFatX(3);
}
PERM_MACRO(R_01_4) {
    board.b1 = board.b1 & MASK_R0_NT | (board.b1 & MASK_R0_B4) >> 12 | (board.b1 & MASK_R0_S4) << 6;
    board.b1 = board.b1 & MASK_R1_NT | (board.b1 & MASK_R1_B4) >> 12 | (board.b1 & MASK_R1_S4) << 6;
    board.addFatX(4);
}
PERM_MACRO(R_01_5) {
    board.b1 = board.b1 & MASK_R0_NT | (board.b1 & MASK_R0_B5) >> 15 | (board.b1 & MASK_R0_S5) << 3;
    board.b1 = board.b1 & MASK_R1_NT | (board.b1 & MASK_R1_B5) >> 15 | (board.b1 & MASK_R1_S5) << 3;
    board.addFatX(5);
}
PERM_MACRO(R_12_1) {
    board.b1 = board.b1 & MASK_R1_NT | (board.b1 & MASK_R1_B1) >> 3 | (board.b1 & MASK_R1_S1) << 15;
    board.b1 = board.b1 & MASK_R2_NT | (board.b1 & MASK_R2_B1) >> 3 | (board.b1 & MASK_R2_S1) << 15;
    board.addFatX(1);
}
PERM_MACRO(R_12_2) {
    board.b1 = board.b1 & MASK_R1_NT | (board.b1 & MASK_R1_B2) >> 6 | (board.b1 & MASK_R1_S2) << 12;
    board.b1 = board.b1 & MASK_R2_NT | (board.b1 & MASK_R2_B2) >> 6 | (board.b1 & MASK_R2_S2) << 12;
    board.addFatX(2);
}
PERM_MACRO(R_12_3) {
    board.b1 = board.b1 & MASK_R1_NT | (board.b1 & MASK_R1_B3) >> 9 | (board.b1 & MASK_R1_S3) << 9;
    board.b1 = board.b1 & MASK_R2_NT | (board.b1 & MASK_R2_B3) >> 9 | (board.b1 & MASK_R2_S3) << 9;
    board.addFatX(3);
}
PERM_MACRO(R_12_4) {
    board.b1 = board.b1 & MASK_R1_NT | (board.b1 & MASK_R1_B4) >> 12 | (board.b1 & MASK_R1_S4) << 6;
    board.b1 = board.b1 & MASK_R2_NT | (board.b1 & MASK_R2_B4) >> 12 | (board.b1 & MASK_R2_S4) << 6;
    board.addFatX(4);
}
PERM_MACRO(R_12_5) {
    board.b1 = board.b1 & MASK_R1_NT | (board.b1 & MASK_R1_B5) >> 15 | (board.b1 & MASK_R1_S5) << 3;
    board.b1 = board.b1 & MASK_R2_NT | (board.b1 & MASK_R2_B5) >> 15 | (board.b1 & MASK_R2_S5) << 3;
    board.addFatX(5);
}
PERM_MACRO(R_23_1) {
    board.b1 = board.b1 & MASK_R2_NT | (board.b1 & MASK_R2_B1) >> 3 | (board.b1 & MASK_R2_S1) << 15;
    board.b2 = board.b2 & MASK_R0_NT | (board.b2 & MASK_R0_B1) >> 3 | (board.b2 & MASK_R0_S1) << 15;
    board.addFatX(1);
}
PERM_MACRO(R_23_2) {
    board.b1 = board.b1 & MASK_R2_NT | (board.b1 & MASK_R2_B2) >> 6 | (board.b1 & MASK_R2_S2) << 12;
    board.b2 = board.b2 & MASK_R0_NT | (board.b2 & MASK_R0_B2) >> 6 | (board.b2 & MASK_R0_S2) << 12;
    board.addFatX(2);
}
PERM_MACRO(R_23_3) {
    board.b1 = board.b1 & MASK_R2_NT | (board.b1 & MASK_R2_B3) >> 9 | (board.b1 & MASK_R2_S3) << 9;
    board.b2 = board.b2 & MASK_R0_NT | (board.b2 & MASK_R0_B3) >> 9 | (board.b2 & MASK_R0_S3) << 9;
    board.addFatX(3);
}
PERM_MACRO(R_23_4) {
    board.b1 = board.b1 & MASK_R2_NT | (board.b1 & MASK_R2_B4) >> 12 | (board.b1 & MASK_R2_S4) << 6;
    board.b2 = board.b2 & MASK_R0_NT | (board.b2 & MASK_R0_B4) >> 12 | (board.b2 & MASK_R0_S4) << 6;
    board.addFatX(4);
}
PERM_MACRO(R_23_5) {
    board.b1 = board.b1 & MASK_R2_NT | (board.b1 & MASK_R2_B5) >> 15 | (board.b1 & MASK_R2_S5) << 3;
    board.b2 = board.b2 & MASK_R0_NT | (board.b2 & MASK_R0_B5) >> 15 | (board.b2 & MASK_R0_S5) << 3;
    board.addFatX(5);
}
PERM_MACRO(R_34_1) {
    board.b2 = board.b2 & MASK_R0_NT | (board.b2 & MASK_R0_B1) >> 3 | (board.b2 & MASK_R0_S1) << 15;
    board.b2 = board.b2 & MASK_R1_NT | (board.b2 & MASK_R1_B1) >> 3 | (board.b2 & MASK_R1_S1) << 15;
    board.addFatX(1);
}
PERM_MACRO(R_34_2) {
    board.b2 = board.b2 & MASK_R0_NT | (board.b2 & MASK_R0_B2) >> 6 | (board.b2 & MASK_R0_S2) << 12;
    board.b2 = board.b2 & MASK_R1_NT | (board.b2 & MASK_R1_B2) >> 6 | (board.b2 & MASK_R1_S2) << 12;
    board.addFatX(2);
}
PERM_MACRO(R_34_3) {
    board.b2 = board.b2 & MASK_R0_NT | (board.b2 & MASK_R0_B3) >> 9 | (board.b2 & MASK_R0_S3) << 9;
    board.b2 = board.b2 & MASK_R1_NT | (board.b2 & MASK_R1_B3) >> 9 | (board.b2 & MASK_R1_S3) << 9;
    board.addFatX(3);
}
PERM_MACRO(R_34_4) {
    board.b2 = board.b2 & MASK_R0_NT | (board.b2 & MASK_R0_B4) >> 12 | (board.b2 & MASK_R0_S4) << 6;
    board.b2 = board.b2 & MASK_R1_NT | (board.b2 & MASK_R1_B4) >> 12 | (board.b2 & MASK_R1_S4) << 6;
    board.addFatX(4);
}
PERM_MACRO(R_34_5) {
    board.b2 = board.b2 & MASK_R0_NT | (board.b2 & MASK_R0_B5) >> 15 | (board.b2 & MASK_R0_S5) << 3;
    board.b2 = board.b2 & MASK_R1_NT | (board.b2 & MASK_R1_B5) >> 15 | (board.b2 & MASK_R1_S5) << 3;
    board.addFatX(5);
}
PERM_MACRO(R_45_1) {
    board.b2 = board.b2 & MASK_R1_NT | (board.b2 & MASK_R1_B1) >> 3 | (board.b2 & MASK_R1_S1) << 15;
    board.b2 = board.b2 & MASK_R2_NT | (board.b2 & MASK_R2_B1) >> 3 | (board.b2 & MASK_R2_S1) << 15;
    board.addFatX(1);
}
PERM_MACRO(R_45_2) {
    board.b2 = board.b2 & MASK_R1_NT | (board.b2 & MASK_R1_B2) >> 6 | (board.b2 & MASK_R1_S2) << 12;
    board.b2 = board.b2 & MASK_R2_NT | (board.b2 & MASK_R2_B2) >> 6 | (board.b2 & MASK_R2_S2) << 12;
    board.addFatX(2);
}
PERM_MACRO(R_45_3) {
    board.b2 = board.b2 & MASK_R1_NT | (board.b2 & MASK_R1_B3) >> 9 | (board.b2 & MASK_R1_S3) << 9;
    board.b2 = board.b2 & MASK_R2_NT | (board.b2 & MASK_R2_B3) >> 9 | (board.b2 & MASK_R2_S3) << 9;
    board.addFatX(3);
}
PERM_MACRO(R_45_4) {
    board.b2 = board.b2 & MASK_R1_NT | (board.b2 & MASK_R1_B4) >> 12 | (board.b2 & MASK_R1_S4) << 6;
    board.b2 = board.b2 & MASK_R2_NT | (board.b2 & MASK_R2_B4) >> 12 | (board.b2 & MASK_R2_S4) << 6;
    board.addFatX(4);
}
PERM_MACRO(R_45_5) {
    board.b2 = board.b2 & MASK_R1_NT | (board.b2 & MASK_R1_B5) >> 15 | (board.b2 & MASK_R1_S5) << 3;
    board.b2 = board.b2 & MASK_R2_NT | (board.b2 & MASK_R2_B5) >> 15 | (board.b2 & MASK_R2_S5) << 3;
    board.addFatX(5);
}
