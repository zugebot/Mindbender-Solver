...
void make_fat_permutation_list_depth_0(vec_PERMOBJ_t& boards_out, const PERMOBJ_t &board_in, const PERMOBJ_t::HasherPtr hasher) {
...
template<bool CHECK_SIMILAR>
void make_fat_permutation_list_depth_1(vec_PERMOBJ_t& boards_out, const PERMOBJ_t &board_in, const PERMOBJ_t::HasherPtr hasher) {
    ...
    for (u64 a = 0; a < FAT_PERM_COUNT; ++a) {
        ...
        boards_out[count].getMemory().setNextNMove<DEPTH>(a);
        ++count;
    }
...
template<bool CHECK_SIMILAR>
void make_fat_permutation_list_depth_2(vec_PERMOBJ_t& boards_out, const PERMOBJ_t &board_in, const PERMOBJ_t::HasherPtr hasher) {
    ...
    for (u64 a = 0; a < FAT_PERM_COUNT; ++a) {
        ...
        for (u64 b = 0; b < FAT_PERM_COUNT; ++b) {
            ...
            (boards_out[count].*hasher)();
            boards_out[count].getMemory().setNextNMove<DEPTH>(move);
            ++count;
        }
    }
...
template<bool CHECK_SIMILAR>
void make_fat_permutation_list_depth_3(vec_PERMOBJ_t& boards_out, const PERMOBJ_t &board_in, const PERMOBJ_t::HasherPtr hasher) {
...
template<bool CHECK_SIMILAR>
void make_fat_permutation_list_depth_4(vec_PERMOBJ_t& boards_out, const PERMOBJ_t &board_in, const PERMOBJ_t::HasherPtr hasher) {
        ...
        for (u64 b = 0; b < FAT_PERM_COUNT; ++b) {
            ...
            for (u64 c = 0; c < FAT_PERM_COUNT; ++c) {
                ...
                for (u64 d = 0; d < FAT_PERM_COUNT; ++d) {
                    ...
                    (boards_out[count].*hasher)();
                    boards_out[count].getMemory().setNextNMove<DEPTH>(move_d);
                    ++count;
                }
            }
        }
...
template<bool CHECK_SIMILAR>
void make_fat_permutation_list_depth_5(vec_PERMOBJ_t& boards_out, const PERMOBJ_t &board_in, const PERMOBJ_t::HasherPtr hasher) {
            ...
            for (u64 c = 0; c < FAT_PERM_COUNT; ++c) {
                ...
                for (u64 d = 0; d < FAT_PERM_COUNT; ++d) {
                    ...
                    for (u64 e = 0; e < FAT_PERM_COUNT; ++e) {
                        ...
                        (boards_out[count].*hasher)();
                        boards_out[count].getMemory().setNextNMove<DEPTH>(move_e);
                        ++count;
                    }
                }
            }
...
void make_permutation_list_depth_0(vec_PERMOBJ_t& boards_out, const PERMOBJ_t &board_in, const PERMOBJ_t::HasherPtr hasher) {
    boards_out[0] = board_in;
    (boards_out[0].*hasher)();
}
...
template<bool CHECK_INTERSECTION, bool CHECK_SIMILAR>
void make_permutation_list_depth_1(vec_PERMOBJ_t& boards_out, const PERMOBJ_t &board_in, const PERMOBJ_t::HasherPtr hasher) {
    static constexpr i32 DEPTH = 1;
    i32 count = 0;

    for (i32 a = 0; a < 60; ++a) {
        PERMOBJ_t *currentPERMOBJ_t = &boards_out[count];
        *currentPERMOBJ_t = board_in;
        allActionsList[a](*currentPERMOBJ_t);
        (currentPERMOBJ_t->*hasher)();
        c_u64 move = a;
        boards_out[count].getMemory().setNextNMove<DEPTH>(move);
        count++;
    }
...
template<bool CHECK_INTERSECTION, bool CHECK_SIMILAR>
void make_permutation_list_depth_2(vec_PERMOBJ_t& boards_out, const PERMOBJ_t &board_in, const PERMOBJ_t::HasherPtr hasher) {
...
template<bool CHECK_INTERSECTION, bool CHECK_SIMILAR>
void make_permutation_list_depth_3(vec_PERMOBJ_t& boards_out, const PERMOBJ_t &board_in, const PERMOBJ_t::HasherPtr hasher) {
...
template<bool CHECK_INTERSECTION, bool CHECK_SIMILAR>
void make_permutation_list_depth_4(vec_PERMOBJ_t& boards_out, const PERMOBJ_t &board_in, const PERMOBJ_t::HasherPtr hasher) {
    static constexpr u32 DEPTH = 4;
...
template<bool CHECK_INTERSECTION, bool CHECK_SIMILAR>
void make_permutation_list_depth_5(vec_PERMOBJ_t& boards_out, const PERMOBJ_t &board_in, const PERMOBJ_t::HasherPtr hasher) {
    static constexpr u32 DEPTH = 5;
...
template<bool CHECK_INTERSECTION, bool CHECK_SIMILAR>
void make_permutation_list_depth_plus_one(const vec_PERMOBJ_t &boards_in, vec_PERMOBJ_t &boards_out, const PERMOBJ_t::HasherPtr hasher) {
    int count = 0;
    u8 intersects = 0;
...
MU void Permutations::reserveForDepth(MU const PERMOBJ_t& board_in, vec_PERMOBJ_t& boards_out, c_u32 depth, c_bool isFat) {
...
void Permutations::getDepthFunc(const PERMOBJ_t &board_in, vec_PERMOBJ_t &boards_out, c_u32 depth, c_bool shouldResize) {
...
void Permutations::getDepthPlus1Func(const vec_PERMOBJ_t& boards_in, vec_PERMOBJ_t& boards_out, c_bool shouldResize) {
    if (shouldResize) {
...
void make_permutation_list_depth_plus_one_buffered(
        ...
        const vec_PERMOBJ_t &boards_in, vec_PERMOBJ_t& board_buffer, PERMOBJ_t::HasherPtr hasher) {
...
void Permutations::getDepthPlus1BufferedFunc(
        const std::string& root_path,
        const vec_PERMOBJ_t& boards_in, vec_PERMOBJ_t& boards_out, int depth) {
